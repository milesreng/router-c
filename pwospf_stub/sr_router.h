...
void sr_send_or_queue_packet(struct sr_instance * , uint8_t * , unsigned int , unsigned int , struct sr_arpcache * ,  uint32_t , struct sr_rt * );
void sr_handle_ping_reply(struct sr_instance* , uint8_t * , unsigned int , char* ); 
void sr_handle_arp(struct sr_instance* , uint8_t * , unsigned int , char* );
void sr_handle_rip(struct sr_instance* , uint8_t * , unsigned int , char* );
